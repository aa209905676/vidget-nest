...
import { ParseVideoCommand, BatchParseVideoCommand } from '../commands/parse-video.command';
...
export class ParseVideoHandler {
   ...
   * 处理批量解析视频命令
   */
  async handleBatch(command: BatchParseVideoCommand): Promise<BatchVideoInfoResponseDto> {
